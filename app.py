...
# --- Page Configuration ---
# Set the page title, layout, and icon for the Streamlit app
st.set_page_config(
...
# --- Sidebar Navigation ---
# Display profile image in the sidebar (optional)
...
# Create a radio button for navigation in the sidebar
...
def show_projects():
    ...
    st.header("🚀 Projects")
    # Project 1: AWS Architecture for 3-Tier Web Hosting
    with st.expander("1. AWS Architecture for 3-Tier Web Hosting", expanded=True):
        ...
        """)
    # Project 2: Automated Cost Optimization System
...
def show_skills():
    """Display the Skills & Certifications section."""
...
def show_contact():
    """Display the Contact section and provide resume download."""
    ...
    try:
        # Provide a download button for the resume PDF
...
# --- Main Content ---
# Display the selected section based on sidebar navigation
if choice == "About Me":
    show_about()
